...
if [[ "$FILENAME" == "readiness-report.md" ]]; then
  ...
  for section in "Overall Score" "Category Breakdown" "Recommended Autonomy Level" "Workflow artifacts" "Collaboration effectiveness" "Blockers" "Roadmap" "Signal evidence"; do
