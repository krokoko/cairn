...
if [[ "$FILENAME" == "verification-report.md" ]]; then
  for section in "Verification Maturity" "Component Breakdown" "Missing Oracles" "Exactness Analysis" "Human Review Requirements" "Autonomy Candidates" "Feedback Loop Completeness" "Workflow Gate Assessment" "Shift-Left Assessment"; do
